...
!   _temp_152 = &c
	add	r14,-48,r1
	store	r1,[r14+-12]
!   ReturnResult: _temp_152  (sizeInBytes=4)
	load	[r14+-12],r1
	store	r1,[r14+8]
	add	r15,52,r15
	pop	r13
...
!   Send message IsEmpty
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_164  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
!   if _temp_164 then goto _Label_163 else goto _Label_162
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_162
	jmp	_Label_163
...
!   _temp_168 = c + 12
	...
	add	r1,12,r1
	store	r1,[r14+-28]
!   Data Move: _temp_167 = *_temp_168  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-32]
...
!   Data Move: _temp_171 = *_temp_172  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   if _temp_171 > dices then goto _Label_170		(int)
	load	[r14+-24],r1
	load	[r14+8],r2
	load	[r2+40],r2
	cmp	r1,r2
