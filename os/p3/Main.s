...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_144:
!   if numNeeded <= dices then goto _Label_146		(int)
	load	[r14+12],r1
	load	[r14+8],r2
	load	[r2+56],r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-36]
!   if intIsZero (_temp_149) then goto _runtimeErrorNullPointer
	load	[r14+-36],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
...
!   _temp_150 = _StringConst_10
	...
	load	[r14+8],r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_151) then goto _runtimeErrorNullPointer
	load	[r14+-28],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting then goto _Label_176 else goto _Label_177
	load	[r14+8],r1
	loadb	[r1+60],r1
	cmp	r1,0
	be	_Label_177
...
! IF STATEMENT...
	mov	133,r13		! source line 133
	mov	"\0\0IF",r10
!   if needed > dices then goto _Label_179		(int)
	load	[r14+8],r1
	load	[r1+64],r1
	load	[r14+8],r2
	load	[r2+56],r2
