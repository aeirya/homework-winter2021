...
_mainEntry:
	...
	set	0xc7ca8675,r3		! .  hashVal = -943028619
...
_CheckVersion_P_Main_:
	...
	set	0xc7ca8675,r4		! myHashVal = -943028619
	cmp	r3,r4
	be	_Label_18
	set	_CVMess1,r1
	call	_putString
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting then goto _Label_139 else goto _Label_138
	load	[r14+8],r1
	loadb	[r1+60],r1
	cmp	r1,0
	be	_Label_138
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_142:
!   _temp_145 = waiting XOR 1		(bool)
	load	[r14+8],r1
	loadb	[r1+60],r1
	mov	1,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_145 then goto _Label_144 else goto _Label_143
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_143
	jmp	_Label_144
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_148:
!   if numNeeded <= dices then goto _Label_150		(int)
	load	[r14+12],r1
	load	[r14+8],r2
	load	[r2+56],r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-32]
!   if intIsZero (_temp_179) then goto _runtimeErrorNullPointer
	load	[r14+-32],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if waiting then goto _Label_182 else goto _Label_183
	load	[r14+8],r1
	loadb	[r1+60],r1
	cmp	r1,0
	be	_Label_183
...
! IF STATEMENT...
	mov	136,r13		! source line 136
	mov	"\0\0IF",r10
!   if needed > dices then goto _Label_185		(int)
	load	[r14+8],r1
	load	[r1+64],r1
	load	[r14+8],r2
	load	[r2+56],r2
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_200 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-24]
