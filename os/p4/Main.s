...
!   Call the function
	...
	mov	"\0\0CA",r10
	call	_function_35_RunThreadManagerTests
! CALL STATEMENT...
!   Call the function
	mov	113,r13		! source line 113
	mov	"\0\0CA",r10
	call	_function_33_RunProcessManagerTests
! CALL STATEMENT...
!   Call the function
	mov	114,r13		! source line 114
	mov	"\0\0CA",r10
	call	_function_31_RunFrameManagerTests
! CALL STATEMENT...
!   Call the function
...
!   _temp_521 = 0		(4 bytes)
	...
	store	r1,[r14+-32]
!   Calculate and save the FOR-LOOP ending value
!   _temp_522 = 20		(4 bytes)
	mov	20,r1
	store	r1,[r14+-28]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_521  (sizeInBytes=4)
	load	[r14+-32],r1
	store	r1,[r14+-44]
_Label_517:
!   Perform the FOR-LOOP termination test
!   if i > _temp_522 then goto _Label_520		
	load	[r14+-44],r1
	load	[r14+-28],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_526 = _function_27_ConditionTestFoo
