...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0xae10ebb2 (decimal -1374622798)
	set	_packageName,r2
	set	0xae10ebb2,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_freeSpace
	set	_Global_freeSpace,r1
	store	r1,[r14+-216]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_filledSpace
	set	_Global_filledSpace,r1
	store	r1,[r14+-212]
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_3	! 8:	CanEat
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: mut = zeros  (sizeInBytes=24)
	load	[r14+8],r4
	add	r4,44,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_628 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_628 [p ] into _temp_629
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_650 = *_temp_654  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_650 == 2 then goto _Label_648		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_648
...
!   _temp_657 = _temp_658 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-20]
!   Move address of _temp_656 [_temp_657 ] into _temp_659
!     make sure index expr is >= 0
	load	[r14+-20],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_655 = *_temp_659  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-28]
!   if _temp_655 == 2 then goto _Label_648		(int)
	load	[r14+-28],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_648
...
!   _temp_674 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_674 [p ] into _temp_675
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_675 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-28],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_695 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_694  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_690:
!   Perform the FOR-LOOP termination test
!   if p > _temp_695 then goto _Label_693		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_701 = *_temp_703  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
